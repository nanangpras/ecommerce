        ...
        <link href="{{url('themes/assets/plugins/DataTables/datatables.min.css')}}" rel="stylesheet">
        <link href="{{url('themes/assets/plugins/select2/css/select2.min.css')}}" rel="stylesheet">
